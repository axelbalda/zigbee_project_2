...
set name_netlist msk_modulator_netlist_fe2.v
...
set vars(config_files) {../SCRIPTS/setup.tcl ../SCRIPTS/innovus_config.tcl}
...
set vars(design) {msk_modulator_io}
set vars(design_dir) {..}
...
set vars(netlist) {../INPUT_DATA/$name_netlist}
...
set vars(setup_path) {..}
set vars(setup_tcl) {../SCRIPTS/setup.tcl}
...
set vars(top) {0}
set vars(top_cell) {msk_modulator_io}
