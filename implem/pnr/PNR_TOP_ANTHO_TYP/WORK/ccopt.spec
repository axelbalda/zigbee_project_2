...
#  Generated on:      Wed Jun 15 11:55:47 2022
#  Design:            top_io
...
set_ccopt_property insertion_delay -pin {t_op/u_cdr/div1/o_nb_P_reg[0]/C} 0.300
set_ccopt_property insertion_delay -pin {t_op/u_cdr/div1/o_nb_P_reg[1]/C} 0.300
set_ccopt_property insertion_delay -pin {t_op/u_cdr/div1/o_nb_P_reg[2]/C} 0.300
set_ccopt_property insertion_delay -pin {t_op/u_cdr/div1/o_nb_P_reg[3]/C} 0.300
set_ccopt_property insertion_delay -pin {t_op/u_cdr/div1/o_nb_P_reg[4]/C} 0.300
set_ccopt_property insertion_delay -pin {t_op/u_cdr/div1/o_nb_P_reg[5]/C} 0.269

# Clocks present at pin io_inClock/Y
#   inClock (period 20.000ns) in timing_config setup_func_mode([../INPUT_DATA/clock_def.sdc ../INPUT_DATA/clock_uncertainty_prects.sdc ../INPUT_DATA/constraints_def_typ.sdc])
...
# Skew group to balance non generated clock:inClock in timing_config:setup_func_mode (sdc ../INPUT_DATA/clock_def.sdc ../INPUT_DATA/clock_uncertainty_prects.sdc ../INPUT_DATA/constraints_def_typ.sdc)
